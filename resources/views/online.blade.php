	    ...
	    <div class="container d-flex align-items-center px-4">
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item active"><a href="/situs_online_pemilik" class="nav-link pl-0">Home</a></li>
	        	<li class="nav-item"><a href="/barang" class="nav-link pl-0">Kembali</a></li>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
									...
									<a href="{{url('/detailbarang_p/'.$p->id_barang)}}" class="btn btn-danger btn-xs" >Lihat</a>
