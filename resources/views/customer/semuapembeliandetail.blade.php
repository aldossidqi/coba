      ...
      <table class="table table-hover table-bordered" >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width="50">{{ $barang->jumlah_dibeli }}</td>
                ...
                <tr>
                  ...
                  <td colspan="1">Rp {{$totalsemua}} </td>
                  <td  style="text-align: center;">
                  @if($status->status == "Menunggu Pembayaran")
                      <a href="{{url('/beliii/'.$user.'/'.$barang->transaction_id)}}" class="btn btn-warning btn-xs "> <span>Bayar</span></a>
                  @else 
                    Sudah dibayar
                  @endif
                  </td>
